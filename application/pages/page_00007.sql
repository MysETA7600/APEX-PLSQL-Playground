...
'    console.log(x);',
'    let fetchRes = fetch(',
'      "https://g69a1aa845f64d7-mydb101.adb.ap-hyderabad-1.oraclecloudapps.com/ords/wksp_dev/users_trigger_source/" +',
'        x',
'    );',
'    fetchRes',
'      .then((res) => res.json())',
'      .then((obj) => {',
'        console.log(obj);',
'        console.log(obj.trg_code);',
'        let mdl=document.getElementsByClassName("t-Dialog-body")[0];',
'        mdl.innerHTML=`',
'        <p id=''sarkar''>${obj.trg_code}<p>',
'        <button type=''button'' onclick=''list_gen()''>Back</button>',
'        <button onclick="myFunction()">Copy text</button>',
'        `',
'      });',
'  }',
'  function list_gen(){let main_url=fetch("https://g69a1aa845f64d7-mydb101.adb.ap-hyderabad-1.oraclecloudapps.com/ords/wksp_dev/users_trigger_source/");',
...
'',
'for (let i in arr) {',
'  arr_tab_list.push(arr[i].trg_name);',
'}',
'',
...
,p_last_upd_yyyymmddhh24miss=>'20230302141412'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17406895895603027)
,p_name=>'all_Triggers'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17407289472603031)
,p_query_column_id=>1
