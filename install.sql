...
@@workspace/remote_servers/g69a1aa845f64d7_mydb101_adb_ap_hyderabad_1_oraclecloudapps_com_ords_wksp_dev.sql
@@application/shared_components/data_profiles/tables.sql
@@application/shared_components/data_profiles/emp.sql
@@application/shared_components/web_sources/tables.sql
@@application/shared_components/web_sources/emp.sql
...
@@application/shared_components/security/authorizations/administration_rights_copy.sql
...
@@application/shared_components/user_interface/lovs/tables.sql
...
@@application/shared_components/security/authentications/sign_up.sql
