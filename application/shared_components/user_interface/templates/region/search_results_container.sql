...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16281505929478028)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16281855478478028)
,p_plug_template_id=>wwv_flow_imp.id(16281505929478028)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16282188454478028)
,p_plug_template_id=>wwv_flow_imp.id(16281505929478028)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16282450558478030)
,p_plug_template_id=>wwv_flow_imp.id(16281505929478028)
,p_name=>'Sub Regions'
