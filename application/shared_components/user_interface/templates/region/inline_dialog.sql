...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(51025985993566230)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51026287685566230)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51026607994566230)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51026922158566231)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51027237647566231)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51027497076566231)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51027785396566231)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51028091226566231)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51028395343566231)
,p_plug_template_id=>wwv_flow_imp.id(51025985993566230)
,p_name=>'Sub Regions'
