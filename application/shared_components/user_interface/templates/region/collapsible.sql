...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(51003292263566219)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51003560773566219)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51003896472566219)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51004209705566219)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51004457065566220)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51004808662566220)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51005068662566220)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51005356086566220)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51005726339566220)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51006031570566220)
,p_plug_template_id=>wwv_flow_imp.id(51003292263566219)
,p_name=>'Sub Regions'
