...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(51035250220566236)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51035497942566236)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51035835057566236)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51036065776566236)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51036447698566236)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51036733947566237)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51036984750566237)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51037334756566237)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51037609583566237)
,p_plug_template_id=>wwv_flow_imp.id(51035250220566236)
,p_name=>'Sub Regions'
