...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(51047656783566243)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51048006332566243)
,p_plug_template_id=>wwv_flow_imp.id(51047656783566243)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51048339308566243)
,p_plug_template_id=>wwv_flow_imp.id(51047656783566243)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51048601412566245)
,p_plug_template_id=>wwv_flow_imp.id(51047656783566243)
,p_name=>'Sub Regions'
