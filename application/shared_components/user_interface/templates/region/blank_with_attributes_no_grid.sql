...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16219643950477995)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16219959283477995)
,p_plug_template_id=>wwv_flow_imp.id(16219643950477995)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16220294532477995)
,p_plug_template_id=>wwv_flow_imp.id(16219643950477995)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16220531513477995)
,p_plug_template_id=>wwv_flow_imp.id(16219643950477995)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16220876233477995)
,p_plug_template_id=>wwv_flow_imp.id(16219643950477995)
,p_name=>'Sub Regions'
