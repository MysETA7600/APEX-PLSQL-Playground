...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16237141409478004)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16237409919478004)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16237745618478004)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16238058851478004)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16238306211478005)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16238657808478005)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16238917808478005)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16239205232478005)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16239575485478005)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16239880716478005)
,p_plug_template_id=>wwv_flow_imp.id(16237141409478004)
,p_name=>'Sub Regions'
