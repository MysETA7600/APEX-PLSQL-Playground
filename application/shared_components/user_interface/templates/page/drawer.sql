...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(16182378353477961)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16182657713477962)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16182948926477962)
,p_page_template_id=>wwv_flow_imp.id(16182378353477961)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16183226320477962)
,p_page_template_id=>wwv_flow_imp.id(16182378353477961)
