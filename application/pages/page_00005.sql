...
'    console.log(x);',
'    let fetchRes = fetch(',
'      "https://g69a1aa845f64d7-mydb101.adb.ap-hyderabad-1.oraclecloudapps.com/ords/wksp_dev/procedures_data/" +',
'        x',
'    );',
'    fetchRes',
'      .then((res) => res.json())',
'      .then((obj) => {',
'        console.log(obj);',
'        console.log(obj.code_s);',
'        let mdl=document.getElementsByClassName("t-Dialog-body")[0];',
'        mdl.innerHTML=`',
'        <p id=''sarkar''>${obj.code_s}<p>',
'        <button type=''button'' onclick=''list_gen()''>Back</button>',
'        <button onclick="myFunction()">Copy text</button>',
'        `',
'      });',
'  }',
'  function list_gen(){let main_url=fetch("https://g69a1aa845f64d7-mydb101.adb.ap-hyderabad-1.oraclecloudapps.com/ords/wksp_dev/procedures_data/");',
...
'',
'for (let i in arr) {',
'  arr_tab_list.push(arr[i].object_name);',
'}',
'',
...
,p_ref_table_name=>'EBA_COUNTRIES_V'
,p_ref_column_name=>'COUNTRY_CODE'
);
