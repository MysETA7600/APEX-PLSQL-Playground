...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50979230900566201)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50979462518566202)
,p_plug_template_id=>wwv_flow_imp.id(50979230900566201)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50979764924566204)
,p_plug_template_id=>wwv_flow_imp.id(50979230900566201)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50980140066566204)
,p_plug_template_id=>wwv_flow_imp.id(50979230900566201)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50980373328566204)
,p_plug_template_id=>wwv_flow_imp.id(50979230900566201)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50980663353566204)
,p_plug_template_id=>wwv_flow_imp.id(50979230900566201)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50981047568566204)
,p_plug_template_id=>wwv_flow_imp.id(50979230900566201)
,p_name=>'Sub Regions'
