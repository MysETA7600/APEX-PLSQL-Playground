...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(51030579233566232)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51030869690566233)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51031164996566234)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51031528987566234)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51031758641566234)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51032137322566234)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51032391873566234)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51032675662566234)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51032964063566234)
,p_plug_template_id=>wwv_flow_imp.id(51030579233566232)
,p_name=>'Sub Regions'
