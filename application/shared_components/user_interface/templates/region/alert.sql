...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16213080046477986)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16213311664477987)
,p_plug_template_id=>wwv_flow_imp.id(16213080046477986)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16213614070477989)
,p_plug_template_id=>wwv_flow_imp.id(16213080046477986)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16213989212477989)
,p_plug_template_id=>wwv_flow_imp.id(16213080046477986)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16214222474477989)
,p_plug_template_id=>wwv_flow_imp.id(16213080046477986)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16214512499477989)
,p_plug_template_id=>wwv_flow_imp.id(16213080046477986)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16214896714477989)
,p_plug_template_id=>wwv_flow_imp.id(16213080046477986)
,p_name=>'Sub Regions'
