...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16259835139478015)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16260136831478015)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16260457140478015)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16260771304478016)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16261086793478016)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16261346222478016)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16261634542478016)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16261940372478016)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16262244489478016)
,p_plug_template_id=>wwv_flow_imp.id(16259835139478015)
,p_name=>'Sub Regions'
