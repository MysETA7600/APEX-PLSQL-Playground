...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16246677431478009)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16246919479478009)
,p_plug_template_id=>wwv_flow_imp.id(16246677431478009)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16247259462478009)
,p_plug_template_id=>wwv_flow_imp.id(16246677431478009)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16247589191478009)
,p_plug_template_id=>wwv_flow_imp.id(16246677431478009)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16247835964478009)
,p_plug_template_id=>wwv_flow_imp.id(16246677431478009)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16248139640478009)
,p_plug_template_id=>wwv_flow_imp.id(16246677431478009)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16248489984478009)
,p_plug_template_id=>wwv_flow_imp.id(16246677431478009)
,p_name=>'Sub Regions'
