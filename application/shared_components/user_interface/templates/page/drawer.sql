...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(50948529207566176)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50948808567566177)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50949099780566177)
,p_page_template_id=>wwv_flow_imp.id(50948529207566176)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50949377174566177)
,p_page_template_id=>wwv_flow_imp.id(50948529207566176)
