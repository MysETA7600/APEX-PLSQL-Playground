...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(51012828285566224)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51013070333566224)
,p_plug_template_id=>wwv_flow_imp.id(51012828285566224)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51013410316566224)
,p_plug_template_id=>wwv_flow_imp.id(51012828285566224)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51013740045566224)
,p_plug_template_id=>wwv_flow_imp.id(51012828285566224)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51013986818566224)
,p_plug_template_id=>wwv_flow_imp.id(51012828285566224)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51014290494566224)
,p_plug_template_id=>wwv_flow_imp.id(51012828285566224)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(51014640838566224)
,p_plug_template_id=>wwv_flow_imp.id(51012828285566224)
,p_name=>'Sub Regions'
