...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50985794804566210)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50986110137566210)
,p_plug_template_id=>wwv_flow_imp.id(50985794804566210)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50986445386566210)
,p_plug_template_id=>wwv_flow_imp.id(50985794804566210)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50986682367566210)
,p_plug_template_id=>wwv_flow_imp.id(50985794804566210)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50987027087566210)
,p_plug_template_id=>wwv_flow_imp.id(50985794804566210)
,p_name=>'Sub Regions'
