...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16269099366478021)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16269347088478021)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16269684203478021)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16269914922478021)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16270296844478021)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16270583093478022)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16270833896478022)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16271183902478022)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16271458729478022)
,p_plug_template_id=>wwv_flow_imp.id(16269099366478021)
,p_name=>'Sub Regions'
