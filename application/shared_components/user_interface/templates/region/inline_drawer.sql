...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(16264428379478017)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16264718836478018)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16265014142478019)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16265378133478019)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16265607787478019)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16265986468478019)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16266241019478019)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16266524808478019)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16266813209478019)
,p_plug_template_id=>wwv_flow_imp.id(16264428379478017)
,p_name=>'Sub Regions'
